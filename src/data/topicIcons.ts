...
export const TOPIC_ICONS: TopicIconDef[] = [
  ...
  { key: 'bus',          label: 'Öffentlicher Verkehr', Icon: Bus,           match: ['bus', 'oev', 'transports', 'trasporti', 'public transport'] },
  ...
  { key: 'cone',         label: 'Verkehrsführung',      Icon: TrafficCone,   match: ['fuehrung', 'leit', 'guidage', 'guida', 'lenkung'] },
  ...
  { key: 'rural',        label: 'Ausserorts / Ländlich', Icon: Trees,         match: ['ausserorts', 'land', 'rural', 'campagne', 'campagna'] },
  { key: 'urban',        label: 'Innerorts / Stadt',     Icon: Building2,     match: ['innerorts', 'stadt', 'localite', 'localita', 'urban', 'siedlung'] },
  { key: 'mountain',     label: 'Berg / Gefälle',       Icon: Mountain,      match: ['berg', 'gefaelle', 'gefall', 'mont', 'pendenza', 'slope'] },
  ...
  { key: 'route',        label: 'Strassenführung',      Icon: Route,         match: ['linienfuehrung', 'trace', 'tracciato', 'route', 'kurv'] },
  { key: 'map',          label: 'Allgemein / Strecke',   Icon: MapIcon,       match: ['strecke', 'segment', 'tracciato', 'parcours'] },
  { key: 'descent',      label: 'Gefälle abwärts',     Icon: ArrowDown,     match: ['abwaerts', 'descend', 'discesa'] },
]
