...
// XR Store als Singleton ausserhalb der Komponente —
// wird an SceneViewer weitergegeben für VR-Session-Steuerung
      ...
      <main className="flex-1 relative overflow-auto">
        <AnimatePresence mode="wait">
                    ...
                    <div className="space-y-6">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          !username.trim() && "opacity-40 cursor-not-allowed hover:scale-100"
                        )}
                      >
          ...
          {view === "training" && currentScene && (
            ...
            >
              {/* SceneViewer erhält den XR Store für VR-Session-Steuerung */}
              <SceneViewer
              ...
              {/* Training-Controls (oben rechts) */}
              <div className="absolute top-4 right-4 z-50 flex items-center gap-3">
                {/* VR starten – Meta Quest Button */}
                <button
                  onClick={() => void xrStore.enterVR()}
                  className="bg-blue-600/80 backdrop-blur-md px-4 py-2 rounded-full border border-blue-400/40 text-xs font-bold text-white hover:bg-blue-500 transition-all flex items-center gap-2"
                >
                  <Maximize2 size={14} />
                  VR starten
                </button>
                                    ...
                                    {(["klein", "mittel", "gross"] as RSIDimension[]).map(v => (
                                      <button
                                        ...
                                        onClick={() => setEditingDeficit({
                                          ...editingDeficit,
                                          correctAssessment: { ...editingDeficit.correctAssessment!, wichtigkeit: v },
                                        })}
                                        className={cn(
                                  ...
                                  <div className="flex gap-2">
                                    {(["klein", "mittel", "gross"] as RSIDimension[]).map(v => (
                                      <button
                                        ...
                                        onClick={() => setEditingDeficit({
                                          ...editingDeficit,
                                          correctAssessment: { ...editingDeficit.correctAssessment!, abweichung: v },
                                        })}
                                        className={cn(
                                          "flex-1 py-2 rounded-lg text-[10px] font-bold uppercase transition-all",
                                  ...
                                  <div className="flex gap-2">
                                    {(["leicht", "mittel", "schwer"] as NACADimension[]).map(v => (
                                      <button
                                        ...
                                        onClick={() => setEditingDeficit({
                                          ...editingDeficit,
                                          correctAssessment: { ...editingDeficit.correctAssessment!, unfallschwere: v },
                                        })}
                                        className={cn(
                                          "flex-1 py-2 rounded-lg text-[10px] font-bold uppercase transition-all",
